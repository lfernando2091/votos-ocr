...
public class CasillaEO extends Component {
    private int _id;
    ...
    public CasillaEO(int _id, String nombre, int version, int operacion) {
        this._id = _id;
        this.nombre = nombre;
    ...
    public Component JSONValues(JSONObject jsonObject) throws JSONException {
        return new CasillaEO(jsonObject.optInt("pkey"),jsonObject.optString("tipo"),jsonObject.optInt("version"),jsonObject.optInt("operacion"));
    }

    @Override
    public String tableName() {
        return Colums.TABLE_CASILLA;
    }
}
